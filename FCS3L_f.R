...
for (i in 1:length(temp)){
  ...
  dataw <- select(dataw,-c(school.W1,school.3,school.4))
  ...
  datL=datL %>% rename(school=school.2)
...
##save the results
write.xlsx(results.est,"FCS3Lf_Results_est.xlsx")
write.xlsx(results.sd,"FCS3Lf_Results_sd.xlsx")
write.xlsx(results.RE,"FCS3Lf_Results_RE.xlsx")
write.xlsx(results.CI,"FCS3Lf_Results_CI.xlsx")
write.xlsx(results.ICC,"FCS3Lf_Results_ICC.xlsx")
